...
?>
    ...
    <div  class="ml-4 mr-4 flex justify-center block bg-white shadow-lg p-4 rounded-lg hover:bg-gray-100 cursor-pointer  border border-gray-300">
    ...
    <dialog id="<?php echo $modal_id; ?>" class="modal ">
        <div class="modal-box">
            ...
            <ul class="m-4">
                ...
                <?php if (!empty($parte['firma_responsable_empresaorigen'])): ?>
                    <li><strong>Firma del responsable de la empresa origen:</strong><br>
                        <img src="<?php echo $parte['firma_responsable_empresaorigen']; ?>" alt="Firma del responsable de la empresa origen" style="max-width: 300px; border: 1px solid #ccc;">
                    </li>
                <?php else: ?>
                ...
                <?php if (!empty($parte['firma_responsable_airtek'])): ?>
                    <li><strong>Firma del responsable de Airtek:</strong><br>
                        <img src="<?php echo $parte['firma_responsable_airtek']; ?>" alt="Firma del responsable de Airtek" style="max-width: 300px; border: 1px solid #ccc;">
                    </li>
                <?php else: ?>
            ...
            <p class="py-4 m-4">Presiona botón ✕ para cerrar</p>
        </div>
    </dialog>
<?php
}
