...
<div class="bg-white rounded-lg  m-4">
    ...
    <div class="grid grid-cols-2 gap-4 mb-6">
        <a href="index.php?action=viewProject&id=39" class="flex justify-start h-24 shadow rounded-lg bg-airtek-primary bg-opacity-20 hover:bg-opacity-10 cursor-pointer transition-all p-4 relative">
        ...
        <a href="index.php?action=viewProject&id=39" class="flex justify-start h-24 shadow rounded-lg bg-airtek-accent bg-opacity-20 hover:bg-opacity-10 cursor-pointer transition-all p-4 relative">
            ...
            <h3 class="text-xl text-black font-semibold mb-2 "> Otro </h3>
