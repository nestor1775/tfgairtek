...
<div class="m-4 p-4 overflow-x-hidden">
    <form class="flex flex-col mx-auto w-full max-w-xl" action="done.php?token=<?= $tokenUnico ?>" method="POST">
        
        <label class="text-lg mb-1" for="id_trabajador">Nombre del trabajador</label>
        <select class="border-2 p-1 border-gray-200 rounded-md w-full" id="id_trabajador" name="id_trabajador" required>
        ...
        <select class="border-2 p-1 border-gray-200 rounded-md w-full" id="extraHours" name="extraHours" required>
            <option value="1" selected>sí</option>
            <option value="0">no</option>
        </select><br>

        <label class="text-lg mb-1" for="festiveDay">Día festivo</label>
        <select class="border-2 p-1 border-gray-200 rounded-md w-full" id="festiveDay" name="festiveDay" required>
            <option value="1" selected>sí</option>
            <option value="0">no</option>
        </select><br>
